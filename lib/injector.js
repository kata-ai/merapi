...
class Injector extends Component.mixin(AsyncEmitter) {
    ...
    register(name, component, isObj) {
        this.emitSync("beforeRegister", name, component, isObj);
        ...
        this.emitSync("afterRegister", name, this.components[name]);
    ...
    *_resolve(name, extra, prev) {
        ...
        if (!com.object) {
            throw new Error("Cannot resolve component '%s'", name);
        }
